...
library(stringr);library(tidyverse);library(dplyr);library(lme4)
...
```{r setup, include=FALSE}
model.train = lmer(CHI_MLU ~ VISIT * Diagnosis + types_CHI + (1+VISIT|ID), data=Assignment1data, REML = FALSE)

#root mean square error on train data
rmse(model.train,Assignment1data) 

rmse(model.train,final) 
