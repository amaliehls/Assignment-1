...
power_interaction=powerSim(model.train,fixed("VISIT:DiagnosisTD"),nsim=20)
# 0.00% power

power_visit = powerSim(model_maineffects,fixed("VISIT"),nsim=20)
# 95 % power

power_diagnosis = powerSim(model_maineffects,fixed("DiagnosisTD"),nsim=20)
# 0.00 % power

power_types=powerSim(model.train,fixed("types_CHI"),nsim=20)
#100 % power
...
powercurveinteraction = powerCurve(model.train, fixed("VISIT:DiagnosisTD"),along = "ID",nsim = 10)
